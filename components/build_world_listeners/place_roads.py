...
def road_between(scene, start, end) -> Iterator[Tuple[int, int]]:
...
class PlaceRoads(BuildWorldListener):
    def on_build_world(self, scene):
        ...
        for coord in list(get_3_by_3_square(avg_x, avg_y)):
        ...
        for coord in house_coords:
            ...
            for node in road_between(scene, (coord.x, coord.y), (avg_x, avg_y)):
