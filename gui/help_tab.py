...
class HelpTab(GuiElement):
    ...
    def render(self, panel):
        ...
        panel.print(self.x, self.y+10, "a      : Fast Forward", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+11, "`      : Debug", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+12, "ESC    : Back", fg=self.fg, bg=self.bg)
