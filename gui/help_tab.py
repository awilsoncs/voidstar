...
class HelpTab(GuiElement):
    ...
    def render(self, panel):
        ...
        panel.print(self.x, self.y+11, "c      : Buy Cow", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+12, "k      : Hire Knight", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+13, "h      : Cook Haunch", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+14, "g      : Sell Thing", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+15, "a      : Fast Forward", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+16, "`      : Debug", fg=self.fg, bg=self.bg)
        panel.print(self.x, self.y+17, "ESC    : Back", fg=self.fg, bg=self.bg)
